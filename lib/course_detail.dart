Map<String, String> courseDetail = {
  ...
  "CMP 211":
      "This course is all about problem solving methods and algorithm development, designing, coding, debugging and documenting programs using techniques of a good programming language style. You will do all these using JAVA or Javascript programming.",
  "CMP212":
  ...
  "CMP 319": "CMP All about project writing from chapter one to chapter five",
};
